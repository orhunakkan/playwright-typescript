...
test.describe('Viewport', () => {
    ...
    test('page.setViewportSize() - set the viewport size and dimension', async ({page}) => {
        ...
        await page.waitForTimeout(200);
        await page.setViewportSize({width: 768, height: 1024}); // ipad-2 portrait
        await page.waitForTimeout(200);
        await page.setViewportSize({width: 480, height: 320}); // iphone-4 landscape
        await page.waitForTimeout(200);
    });
});
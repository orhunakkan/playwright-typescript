...
test.describe('Reqres API Tests', () => {
    ...
    test('should create a new user', async ({request}) => {
        const response = await request.post(`${baseURL}/users`, {data: samplePayload.newUser});
    ...
    test('should update a user', async ({request}) => {
        const response = await request.put(`${baseURL}/users/2`, {data: samplePayload.updatedUserPut});
        expect(response.status()).toBe(200);
        const responseBody = await response.json();
        expect(responseBody).toHaveProperty('name', samplePayload.updatedUserPut.name);
        expect(responseBody).toHaveProperty('job', samplePayload.updatedUserPut.job);
    });

    // Test to update a user using PATCH
    test('should update a user with PATCH', async ({request}) => {
        const response = await request.patch(`${baseURL}/users/2`, {data: samplePayload.updatedUserPatch});
        expect(response.status()).toBe(200);
        const responseBody = await response.json();
        expect(responseBody).toHaveProperty('name', samplePayload.updatedUserPatch.name);
        expect(responseBody).toHaveProperty('job', samplePayload.updatedUserPatch.job);
    });
    ...
    test('should register a user successfully', async ({request}) => {
        const response = await request.post(`${baseURL}/register`, {data: samplePayload.newUserRegister});
        expect(response.status()).toBe(200);
        const responseBody = await response.json();
    ...
    test('should fail to register a user', async ({request}) => {
        const response = await request.post(`${baseURL}/register`, {data: samplePayload.failedUserRegister});
    ...
    test('should login a user successfully', async ({request}) => {
        const response = await request.post(`${baseURL}/login`, {data: samplePayload.userLogin});
        expect(response.status()).toBe(200);
        const responseBody = await response.json();
        expect(responseBody).toHaveProperty('token');
    });
    ...
    test('should fail to login a user', async ({request}) => {
        const response = await request.post(`${baseURL}/login`, {data: samplePayload.failedUserLogin});
        expect(response.status()).toBe(400);
        const responseBody = await response.json();
        expect(responseBody).toHaveProperty('error');
    });

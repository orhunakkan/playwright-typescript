...
- `locator.click()` on the same button *not* incrementing the tap counter (touch vs. mouse distinction)
...
The `devices["iPhone 15"]` context (AC-5) is launched as an ad-hoc context *within* each of these
